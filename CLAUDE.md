...
2. **課程框架**（6 張）：目標、**learning objectives**、W6 是樞紐、三條主軸、實務說明。
...
大綱 W1 指定的三個誤解都在裡面；「end-to-end 一定更好」由比較矩陣那張點名。
...
講稿寫在 `slides/w01.qmd` 的 `::: {.notes}` 區塊（W1 共 **33 段、約 12,100 字**）。
