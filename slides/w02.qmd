...
First zero at $f_s/L$, so the main lobe is $2f_s/L$ wide. Centre the window at $n = 0$ and Hann is $w(n) = \tfrac12 + \tfrac12\cos(2\pi n/L)$: the cosine is two complex exponentials, so its spectrum is **three copies** of $W$ with weights $\tfrac12, \tfrac14, \tfrac14$, shifted by $0$ and $\pm f_s/L$.
